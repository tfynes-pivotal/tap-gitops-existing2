...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-existing2
echo     https://github.com/tfynes-pivotal/tap-gitops-existing2
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-existing2 --public
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-existing2
git branch -M main
